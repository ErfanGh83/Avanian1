...
const SignUpForm = () => {
  const [formData, setFormData] = useState<FormData>({
    ...
    lastName: '',
    phoneNumber: '',
    age: 1 // More reasonable default age
  })
  ...
  return (
    <form 
      ...
      className='w-full max-w-md flex flex-col gap-6 p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg dark:shadow-gray-900/50 rtl'
    >
